      ...
      <section className="section">
        <div className="container">
          ...
          <div className="campaign-grid">
            {CAMPAIGNS.map((c) => (
              <Link key={c.id} href={`/detail?id=${c.id}`} className="camp-card emerald-glow featured-camp" style={{textDecoration:'none'}}>
                <div className="camp-img" style={{background:c.heroGradient,fontSize:48,display:'flex',alignItems:'center',justifyContent:'center'}}>
                  <div className="camp-img-inner">{c.heroIcon}</div>
                ...
                <div className="camp-body">
                  ...
                  <div className="prog-track" style={{height:8}}><div className={`prog-fill ${c.category === 'Education' ? 'prog-gold' : 'prog-emerald'}`} style={{width:`${c.pct}%`}}/></div>
